...
class Contact_mgr extends Base_Controller
{
 ...
 //       ["文字3",             "content3",             "text",             "",         TRUE,     "",     4,         12,],
    ...
    private $form_param = [
       ...
       // ["獵場封面圖",             "banner",             "img_multi_without_crop",             "",         TRUE,     "",     12,         12, 2 / 1],
        ...
        ["Message",             "message",                 "textarea",             "",         FALSE,     "",     12,         12],
        // ["審核問題2",             "q2",                 "text",             "",         FALSE,     "",     12,         12],
        // ["審核問題3",             "q3",                 "text",             "",         FALSE,     "",     12,         12],
    ];
    ...
    public function __construct()
    {
        ...
        $this->action = base_url() . 'mgr/contact_mgr/';
    }
    ...
    public function index()
    {
        ...
        $contact = $this->Contact_model->get_mgr_data(1);
        ...
        $this->data = array_merge($this->data, array(
            'sub_active'              => 'CONTACT_MGR',
            'parent'                  => '',
            // 'parent_link'             => base_url() . 'mgr/event/main',
            'custom_del_url'          => base_url() . 'mgr/contact_mgr/local_del',
            'title'                   => '圖片列表',
            'action'                  => $this->action,
        ...
        if ($_POST) {
            ...
            // !d($data);
            // exit;
            if ($this->Contact_model->edit_mgr(1, $data)) {

                $this->js_output_and_redirect("編輯成功", base_url() . "mgr/contact_mgr/");
            } else {
            ...
            $this->data['type'] = 'edit';
            $this->data['param'] = $this->set_data_to_param($this->param, $contact);
            $this->data['title'] = '編輯照片';
           // $this->data['sub_active'] =  'CONTACT';

            $this->data['parent'] = '圖片列表';
            $this->data['parent_link'] = base_url() . "mgr/contact_mgr/";

            $this->data['action'] = base_url() . "mgr/contact_mgr/";
