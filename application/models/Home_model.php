...
*/
	...
	public function edit($home_id, $data)
	{
		...
		return $this->db->where(array("id" => $home_id))->update('home', $data);
	}
	...
	public function add($data)
	{
		...
		$res = $this->db->insert($this->home_table, $data);
	...
	{
		return $this->db->get_where($this->home_table, array("id" => $home_id))->row_array();
	}
	...
	{
		$total = $this->db->select()->from($this->home_table)->where($syntax)->get()->num_rows();
	...
	public function get_ready_carousel()
	{
	...
	public function get_service_img(){
	...
	public function get_shop_carousel(){
		$type = 'shop';
