<tr data-id="<?= $item['id'] ?>">
    ...
    <td>
        ...
        <button class="btn btn-primary btn-xs" onclick="location.href='<?= base_url() ?>mgr/acdemic/local_edit/<?= $item['id'] ?>';" data-toggle="tooltip" data-original-title="編輯"><i class="fa fa-fw ti-pencil"></i></button>
