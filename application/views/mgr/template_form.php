                            ...
                            ?>
                                ...
                                <? else : ?>
                                    <div class="form-group">
                                        ...
                                        <? elseif ($item[2] == "img") : ?>
                                            <input data-multi="false" data-ratio="<?= $item[6] ?>" data-related="<?= $item[1] ?>" class="img_upload" type="file" id="imgupload_<?= $item[1] ?>" style="display: none;" accept="image/*">
                                            <? if (isset($can_edit) && !$can_edit) : ?><? else : ?>
